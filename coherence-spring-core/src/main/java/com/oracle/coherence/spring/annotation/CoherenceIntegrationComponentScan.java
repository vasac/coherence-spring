...
import com.oracle.coherence.spring.messaging.CoherencePublisherComponentScanRegistrar;
 ...
 * <p>
 * Scans for {@link CoherencePublisher} on interfaces to create {@code GatewayProxyFactoryBean}s.
 *
 * @author Artem Bilan
 * @since 4.0
 *
...
@Documented
@Import(CoherencePublisherComponentScanRegistrar.class)
public @interface CoherenceIntegrationComponentScan {
	/**
