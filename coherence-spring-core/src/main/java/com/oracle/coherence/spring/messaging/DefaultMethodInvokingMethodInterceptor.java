	...
	enum MethodHandleLookup {
		...
		ENCAPSULATED {
			...
			private final transient Method privateLookupIn =
					ReflectionUtils.findMethod(MethodHandles.class, "privateLookupIn", Class.class, MethodHandles.Lookup.class);
		...
		OPEN {
			...
			@Nullable
			private final transient Constructor<MethodHandles.Lookup> constructor;
