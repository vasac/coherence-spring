:main-release-version: 4.2.0
:main-snapshot-version: 4.2.1-SNAPSHOT
...
|*4.x*            | `17`, `21`      | `24.09`      | `6.x` | `3.3.x` | ✔       | `main`
|*3.x*            | `11`, `17`, `21`| `22.06`      | `5.x` | `2.x`   |         | `3.x`
|===
...
only support the jakarta namespace. Commercial editions compatible with Coherence Spring 3.x are
Coherence 14.1.1.2206 and 14.1.2.0.
